...
public class EmailUtil {
    ...
    public static String myEmailAccount = "cuijiayong@sythealth.com";
    public static String myEmailPassword = "CJYhyh520";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "892950696@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "测试XX网站", "UTF-8"));
    ...
    public static MimeMessage createMimeMessage1(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("E://文档/pics/img2.jpg")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("E://test/yue.xlsx"));  // 读取本地文件
